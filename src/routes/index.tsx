...
// import {RequireRoleOutlet} from '@/routes/RequireRoleOutlet'
//
// import {SelectLocker} from '@/pages/Shipper/SelectLocker'
// import {PackageInfo} from '@/pages/Shipper/PackageInfo'
// import {Success} from '@/pages/Shipper/Success'
...
//     {
//         path: '/shipper',
//         element: <RequireRoleOutlet allowedRole={EUserRole.shipper} loginPath="/shipper/login"/>,
//         children: [
...
//     {
//         path: '/customer',
//         element: <RequireRoleOutlet allowedRole={EUserRole.user} loginPath="/customer/login"/>,
//         children: [
//             {
//                 element: <CustomerLayout/>,
//                 children: [
