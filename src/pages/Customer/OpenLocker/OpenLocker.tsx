                            ...
                            <div className={styles.stepsGrid}>
                                ...
                                <div className={styles.stepItem}>
                                    ...
                                    <div className={styles.stepText}>
                                        ...
                                        <p className={styles.stepDesc}>Bấm mã OTP trực tiếp vào bàn phím số bên
                                            phải.</p>
                                    </div>
                                </div>
                    ...
                    <div className={styles.rightCol}>
                        ...
                        <div className={styles.numpad}>
                            {DIGITS.map((d, i) => {
                                ...
                                if (d === '⌫') return (
                                    <button key={i} className={`${styles.key} ${styles.keyDel}`}
                                            onClick={deleteOtpDigit} aria-label="Xóa">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                             stroke="currentColor"
                                             strokeWidth="2">
